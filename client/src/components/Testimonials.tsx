...
const testimonials = [
  {
    ...
    rating: 5,
    content: 'DecoBlu USA transformed our restaurant\'s interior completely. The cabinet wrapping looks absolutely stunning and has held up perfectly over two years. Excellent communication and professional installation.',
    avatar: null,
  },
  {
    name: 'Robert Chen',
    role: 'Hotel Manager',
    content: 'After researching architectural vinyl companies, we chose DecoBlu USA for our hotel renovation. If you\'re serious about quality interior transformation at the right price, this is the company to choose.',
    rating: 5,
    avatar: null,
  },
  {
